    ...
    if (validateForm()) {
      ...
      try {
        ...
        if (
          ...
          "Email already Exists, Proceed to signin"
        ) {
          setErrors({ email: "Email already exists. Proceed to Sign In." });
        }
        if (
          error.response?.data?.error ===
          "Username and Email already Exists, Proceed to signin"
        ) {
          setErrors({ email: "Username and Email already Exists, Proceed to signin" });
        }
      } finally {
        setLoading(false);
      }
  ...
  return (
    <div className="signup-container">
      ...
      <form className="signup-form" onSubmit={handleSubmit}>
        ...
        >
          {formData.email && (
            <label className="focused" htmlFor="email">
              Email
            </label>
          )}
          <input
